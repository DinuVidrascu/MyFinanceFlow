    ...
    >
      <div className="bg-white w-full max-w-lg rounded-t-2xl sm:rounded-2xl p-6 shadow-2xl animate-slide-up flex flex-col max-h-[90vh]">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-lg font-bold text-gray-800">{currentGroup.id ? 'Editează Lista' : 'Listă Nouă'}</h3>
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-end mb-2">
                ...
                <span className="text-xs font-bold text-indigo-600">Total: {formatCurrency(getGroupTotal(currentGroup.items))}</span>
              </div>
